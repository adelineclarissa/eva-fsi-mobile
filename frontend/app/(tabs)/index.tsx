...
export default function HomeScreen() {
  ...
  const { accounts, isLoading, refresh } = useAccountStore();
  ...
  const headerStyle = useAnimatedStyle(() => ({
    ...
    transform: [{ translateY: interpolate(scrollY.value, [0, 80], [0, -10], Extrapolation.CLAMP) }],
  }));
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <Animated.View style={[styles.header, headerStyle]}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.userName}>MIRA SETIAWAN</Text>
      ...
      {/* Tombol AI — fixed, tidak mengambang */}
...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: 20, color: Colors.textPrimary, fontWeight: '800', letterSpacing: 0.3 },
  rewardsBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  rewardsBadgeText: { fontSize: 11, color: Colors.accentGold, fontWeight: '600' },
