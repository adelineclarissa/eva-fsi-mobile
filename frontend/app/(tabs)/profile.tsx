    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
          ...
          >
            ...
            <View style={styles.statsRow}>
              {[
                ...
                { label: "Tingkat", value: tierLabel.replace("Anggota ", "") },
              ].map((stat) => (
            ...
            <View style={styles.menuGrid}>
              {MENU_ITEMS.map((item) => (
                <Pressable
                  ...
                  style={({ pressed }) => [
                    styles.menuGridItem,
                    pressed && styles.menuGridItemPressed,
                  ]}
                  onPress={() =>
                    Alert.alert(item.label, "Fitur ini akan segera tersedia!")
                  }
                >
                  <View
                    style={[
                  ...
                  <Text style={styles.menuGridLabel} numberOfLines={2}>
                    {item.label}
                  </Text>
                </Pressable>
              ))}
        ...
        <Text style={styles.version}>
          EVA Banking v1.0.0 · Dibuat dengan ❤️
        </Text>
